...
<title>Seller Login | Online E-Store</title>
...
<body>
	...
	<div class="container my-4">
		<div class="row">
			<div class="col my-5">
				<h1 class="text-center mb-5">Seller Login</h1>
				<h5 class="text-center">
					Go <a href="${pageContext.request.contextPath}/Login.jsp">back</a> to
					login selection.
				</h5>
			</div>
		</div>
		<div class="row">
			...
			<div
				...
				<img id="illustration"
					src="${pageContext.request.contextPath}/Assets/svg/login.svg"
					class="img-fluid" alt="" />
			</div>
		</div>
	</div>
