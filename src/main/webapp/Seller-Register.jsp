...
<html lang="en">
  <head>
    ...
    <title>Seller Register | Online E-Store</title>
    <!-- CSS -->
    ...
    <div class="container">
      <div class="row">
      	<div class="col my-5 pb-2">
	        <h1 class="text-center my-5">Seller Register Page</h1>
      ...
      <form action="${pageContext.request.contextPath}/SellerRegister" method="POST">
	      ...
	      <div class="row">
	        ...
	        <div class="col-12 col-lg-6 mb-4">
	          <div class="mb-3">
	            ...
	            <input type="tel" class="form-control" id="contact-no" name="contact-no" />
	          </div>
	        </div>
	      </div>
	      <div class="row">
	      ...
	      <div class="row">
	        <div class="col">
	          <input type="submit" value="Register Seller" class="d-block property-btn btn btn-outline-blue w-50 mt-4 mb-5 mx-auto" />
	        </div>
	      </div>
      </form>
