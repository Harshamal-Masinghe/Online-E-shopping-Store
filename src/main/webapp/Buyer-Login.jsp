...
<title>Buyer Login | Online E-Store</title>
...
<body>
	...
	<div class="container my-4">
		<div class="row">
			<div class="col my-5">
				<h1 class="text-center mb-5">Buyer Login</h1>
